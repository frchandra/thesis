...
NS_LOG_COMPONENT_DEFINE("BaselineUdp");
...
int main(){
    LogComponentEnable("BaselineUdp", LOG_LEVEL_INFO);
    ...
    uint16_t port = 9;
    std::string p2pApGwDataRate = "200Mbps";
    std::string p2pApGwDelay = "2ms";
    std::string p2pGwServerDataRate = "00Mbps";
