...
int main(){
    ...
    if(isUpstream == true){
        ...
        tcpOnoffUp.SetAttribute("OnTime", StringValue("ns3::ConstantRandomVariable[Constant="+ ofOnTime +"]"));
        tcpOnoffUp.SetAttribute("OffTime", StringValue("ns3::ConstantRandomVariable[Constant="+ ofOffTime +"]"));
        for(int i = 0; i < nTcp; i++){
    ...
    if(isUpstream == true){
        ...
        quicOnoffUp.SetAttribute("OnTime", StringValue("ns3::ConstantRandomVariable[Constant="+ ofOnTime +"]"));
        quicOnoffUp.SetAttribute("OffTime", StringValue("ns3::ConstantRandomVariable[Constant="+ ofOffTime +"]"));
        for(int i = 0; i < nQuic; i++){
